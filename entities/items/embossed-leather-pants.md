...
- [Embossed Leather Pants](../recipes/leatherworking/classic-vanilla/embossed-leather-pants.md)
...
`item` `recipe-output` `pants` `leatherworking` `classic-vanilla` `manual-html-import`
