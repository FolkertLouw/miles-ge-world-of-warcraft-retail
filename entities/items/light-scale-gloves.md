...
- [Light Scale Gloves](../recipes/leatherworking/classic-vanilla/light-scale-gloves.md)
...
`item` `recipe-output` `gloves` `scale` `leatherworking` `classic-vanilla` `manual-html-import`
